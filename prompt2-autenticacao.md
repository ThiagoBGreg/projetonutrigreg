...
Agora vamos criar a autenticação do sistema. O sistema deve permitir que um nutricionista crie uma conta e faça login. Use o Neon Auth que já está configurado no projeto "projeto nutri greg".
...
- Logo com a imagem do logo e texto "Nutri Rodrigues - NUTRIÇÃO E BEM-ESTAR" no topo de ambas as telas
